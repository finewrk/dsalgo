...
public class TreePage {
	...
	WebElement overviewOfTreesLink; // 1
	@FindBy(linkText = "Terminologies")
	WebElement terminologiesLink; // 2
	@FindBy(linkText = "Types of Trees")
	WebElement typesoftreesLink; // 3
	@FindBy(linkText = "Tree Traversals")
	WebElement treetraversalsLink; // 4
	@FindBy(linkText = "Traversals-Illustration")
	WebElement trav_illustrationsLink; // 5
	@FindBy(linkText = "Binary Trees")
	WebElement binarytreesLink; // 6
	@FindBy(linkText = "Types of Binary Trees")
	WebElement typesofBinaryTreesLink; // 7
	@FindBy(linkText = "Implementation in Python")
	WebElement implementationInPythonLink; // 8
	@FindBy(linkText = "Binary Tree Traversals")
	WebElement binaryTreeTraversalsLink; // 9
	@FindBy(linkText = "Implementation of Binary Trees")
	WebElement implementationOfBinaryTreesLink; // 10
	@FindBy(linkText = "Applications of Binary trees")
	WebElement applicationsOfBinaryTreesLink; // 11
	@FindBy(linkText = "Binary Search Trees")
	WebElement binarySearchTreesLink; // 12
	@FindBy(linkText = "Implementation Of BST")
	WebElement implementationOfBSTLink; // 13
	@FindBy(linkText = "Practice Questions")
	WebElement practiceQuestionLink; // 14
	...
	public void userInput1(String pythoncode) {
		editorInput.sendKeys(pythoncode);
	}
